...
class SimpleBlock(nn.Module):
    ...
    def __init__(self, indim, outdim, half_res):
        ...
        # self.BN1 = nn.GroupNorm(32, outdim)

        self.C2 = nn.Conv2d(outdim, outdim, kernel_size=3,
                            padding=1, bias=False)
        self.BN2 = nn.BatchNorm2d(outdim)
        # self.BN2 = nn.GroupNorm(32, outdim)
        ...
        if indim != outdim:
            ...
            # self.BNshortcut = nn.GroupNorm(32, outdim)
...
class ResNet(nn.Module):
    def __init__(self, block, list_of_num_layers, list_of_out_dims, flatten=False):
        ...
        # bn1 = nn.GroupNorm(32, list_of_out_dims[0])
